  ...
  return (
    <div className="mx-auto max-w-5xl px-4 lg:px-8 py-16">
      <div className="text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.25em] text-brand-royal">Hablemos</p>
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-2">
        <a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="group relative overflow-hidden rounded-3xl bg-brand-radial p-8 text-white card-hover">
          <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-emerald-500/40 blur-3xl" />
          <div className="relative">
            ...
            <span className="mt-5 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-brand-deep">
              Escribinos ahora
            </span>
          </div>
        </a>
